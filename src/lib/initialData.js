...
import { createSampleGpsSelfieSvg } from '../utils/sampleSelfies';

export const INITIAL_ATTENDANCE = [
  {
    id: 'att-20260925-01',
    teacher_id: 'tch-cs-001',
    emp_id: 'MIT-SOE-CS-001',
    teacher_name: 'Dr. Abhijit Patil',
    cadre: 'Professor & HOD',
    department: 'Computer Science & Engineering (CSE)',
    date: '2026-09-25',
    punch_in_time: '09:05:22',
    punch_out_time: null,
    punch_type: 'IN',
    status: 'Present',
    work_mode: 'On Campus',
    ...
    altitude: 564.2,
    accuracy: 3.5,
    location_name: 'MIT-ADT University SOE Building, Rajbaug Campus, Pune',
    geofence_status: 'Inside Campus (Verified)',
    selfie_url: createSampleGpsSelfieSvg({
      name: 'Dr. Abhijit Patil',
      empId: 'MIT-SOE-CS-001',
      time: '09:05:22 AM',
      date: '25 Sep 2026',
      location: 'SOE Academic Block, Rajbaug Campus Pune',
      punchType: 'PUNCH IN',
      avatarBg: '#2a144e'
    })
  },
  {
    ...
    emp_id: 'MIT-SOE-CS-002',
    teacher_name: 'Dr. Priya Sharma',
    cadre: 'Associate Professor',
    department: 'Computer Science & Engineering (CSE)',
    date: '2026-09-25',
    punch_in_time: '09:12:45',
    punch_out_time: null,
    punch_type: 'IN',
    status: 'Present',
    work_mode: 'Lecture & AI Lab',
    latitude: 18.490150,
    longitude: 74.025380,
    altitude: 563.8,
    accuracy: 4.1,
    location_name: 'AI & Robotics Research Lab, Rajbaug, Pune',
    geofence_status: 'Inside Campus (Verified)',
    selfie_url: createSampleGpsSelfieSvg({
      name: 'Dr. Priya Sharma',
      empId: 'MIT-SOE-CS-002',
      time: '09:12:45 AM',
      date: '25 Sep 2026',
      location: 'AI & Robotics Lab, Rajbaug Pune',
      punchType: 'PUNCH IN',
      avatarBg: '#4a154b'
    })
  },
  {
    ...
    emp_id: 'MIT-SOE-CS-003',
    teacher_name: 'Mr. Sandeep Kulkarni',
    cadre: 'Assistant Professor',
    department: 'Computer Science & Engineering (CSE)',
    date: '2026-09-25',
    punch_in_time: '09:42:10',
    punch_out_time: null,
    punch_type: 'IN',
    status: 'Late',
    work_mode: 'Cloud Computing Lab',
    latitude: 18.490400,
    longitude: 74.025600,
    altitude: 565.0,
    accuracy: 5.0,
    location_name: 'Engineering Computer Complex, Rajbaug Campus, Pune',
    geofence_status: 'Inside Campus (Verified)',
    selfie_url: createSampleGpsSelfieSvg({
      name: 'Mr. Sandeep Kulkarni',
      empId: 'MIT-SOE-CS-003',
      time: '09:42:10 AM',
      date: '25 Sep 2026',
      location: 'Engineering Computer Complex, Rajbaug',
      punchType: 'PUNCH IN',
      avatarBg: '#1e3a5f'
    })
  },
  {
    id: 'att-20260925-04',
    teacher_id: 'tch-it-001',
    emp_id: 'MIT-SOE-IT-001',
    teacher_name: 'Dr. Harsha Jain',
    cadre: 'Professor & HOD',
    department: 'Information Technology (IT)',
    date: '2026-09-25',
    punch_in_time: '08:58:30',
    punch_out_time: null,
    punch_type: 'IN',
    status: 'Present',
    work_mode: 'On Campus',
    ...
    altitude: 564.0,
    accuracy: 3.2,
    location_name: 'IT Department Wing, Rajbaug Campus, Loni Kalbhor, Pune',
    geofence_status: 'Inside Campus (Verified)',
    selfie_url: createSampleGpsSelfieSvg({
      name: 'Dr. Harsha Jain',
      empId: 'MIT-SOE-IT-001',
      time: '08:58:30 AM',
      date: '25 Sep 2026',
      location: 'IT Department Wing, Rajbaug Campus Pune',
      punchType: 'PUNCH IN',
      avatarBg: '#134e4a'
    })
  },
  {
    id: 'att-20260925-05',
    teacher_id: 'tch-it-002',
    emp_id: 'MIT-SOE-IT-002',
    teacher_name: 'Mr. Ganesh Mulik',
    cadre: 'Assistant Professor',
    department: 'Information Technology (IT)',
    date: '2026-09-25',
    punch_in_time: '09:18:05',
    punch_out_time: null,
    punch_type: 'IN',
    status: 'Present',
    work_mode: 'Web Tech Lab',
    latitude: 18.490280,
    longitude: 74.025440,
    altitude: 563.9,
    accuracy: 4.0,
    location_name: 'MIT Central Library & Computing Wing, Pune',
    geofence_status: 'Inside Campus (Verified)',
    selfie_url: createSampleGpsSelfieSvg({
      name: 'Mr. Ganesh Mulik',
      empId: 'MIT-SOE-IT-002',
      time: '09:18:05 AM',
      date: '25 Sep 2026',
      location: 'MIT Central Library & Computing Wing',
      punchType: 'PUNCH IN',
      avatarBg: '#1f2937'
    })
  },
  {
    ...
    department: 'Computer Science & Engineering (CSE)',
    date: '2026-09-24',
    punch_in_time: '09:02:15',
    punch_out_time: '17:35:10',
    punch_type: 'OUT',
    status: 'Present',
    work_mode: 'On Campus',
    latitude: 18.490218,
